...
//$(".octothorpe").closest('div.section').toggleClass('fold').(function(){
//                                                                 console.log('fold',$('octothorpe').closest('div.section').length);
//                                                             });
...
//                                  //$cfold.hide();
//                                  if (flag===0 ){
//                                      //!$pfold.hasClass("fold") && !$cfold.hasClass("fold")) {
//                                      $cfold.hide();
//                                      //.addClass('fold');
//                                      $pfold.hide();
//                                      //.addClass('fold');
...
//                                  e.preventDefault();
//
//                                  $(this).closest('.octowrap').siblings('p').slideUp().addClass(".fold").hide();
//                                  //slideUp().addClass(".fold");
//                                  $(this).closest('.docs').siblings('.code').slideUp().addClass('.fold').hide();
//
//                                  //.hide();
//                                  //slideUp().addClass(".fold");
//                                  console.log('fold', $('.fold').length);
...
//hide parent sibling 'p'
//hide grand parents(.section)

//so want function to delete from h3 to h3 of other div id=section-++
