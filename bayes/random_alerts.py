...
def main():
    ...
    suite1 = Hockey('top_alert1')
    suite2 = Hockey('top_alert2')

    thinkplot.Clf()
    thinkplot.PrePlot(num=2)
    thinkplot.Pmf(suite1)
    thinkplot.Pmf(suite2)
    thinkplot.Save(root='alert0',
                xlabel='number hard_alert',
                ylabel='Probability',
                formats=formats)
